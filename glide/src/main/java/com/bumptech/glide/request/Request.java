 ...
 * <p>
 * 用来给一个{@link com.bumptech.glide.request.target.Target}加载资源的请求
 */
public interface Request {
     ...
     * <p>
     * 用来判断图片加载状态是否变化（即由{@link BaseRequestOptions#getPlaceholderDrawable()}
     * 状态转变成获取成功后的图片状态或获取失败后的{@link BaseRequestOptions#getErrorPlaceholder()}）
     */
