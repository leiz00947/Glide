 ...
 * <p>
 * 用来安全存储一个{@link RequestManager}的{@link Fragment}
 *
...
public class RequestManagerFragment extends Fragment {
    ...
    /**
     * 每个{@link Activity}和其内嵌套的{@link Fragment}持有同一个该对象
     * <p>
     * 该变量表示{@link Activity}所对应的{@link RequestManagerFragment}实例
     */
    @Nullable
     ...
     * <p>
     * 判断传参{@link Fragment}是否嵌套在该{@link RequestManagerFragment}所对应的{@link Fragment}中
     */
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
    ...
    /**
     * 将当前{@link RequestManagerFragment}实例注册到父{@link Activity}所对应的
     * {@link RequestManagerFragment}实例的{@link #childRequestManagerFragments}集合中去
     */
    ...
    /**
     * 调用这个确保{@link #childRequestManagerFragments}内的数据不会重复添加
     */
