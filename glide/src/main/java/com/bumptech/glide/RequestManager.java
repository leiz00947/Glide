 ...
 * <p>
 * 管理Glide的请求事件的类。可以智能地暂停、开始或重新请求生命周期事件的连接。
 * 可能是通过实例化一个新的对象来恢复，也可能通过使用Glide来构建负责Activity和Fragment的生命周期的对象。
 *
...
public class RequestManager implements LifecycleListener {
    ...
    /**
     * 一个{@link RequestManager}对象对应一个{@link RequestTracker}实例
     */
    private final RequestTracker requestTracker;
    private final RequestManagerTreeNode treeNode;
    /**
     * 一个{@link RequestManager}对象对应一个{@link TargetTracker}实例
     */
    ...
    /**
     * 要么清理掉容器所持有的请求，要么进一步委托清理，委托清理详见
     * {@link Glide#removeFromManagers(Target)}
     */
    ...
    /**
     * 若清理掉容器所持有的请求就返回{@code true}，否则，返回{@code false}
     */
