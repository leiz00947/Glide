 ...
 * method to the {@link MessageDigest} in {@link #updateDiskCacheKey(MessageDigest)}.
 * <p>
 * 封装一个{@link Object}的{@link Key}的实现类
 * <p>
 * The Object's {@link #toString()} method must be unique and suitable for use as a disk cache key.
 */
