 ...
 * <p>
 * {@link ArrayPool}接口的实现类，一个使用LRU策略来实现移除Array使其始终低于规定最大字节大小的Array Pool
 */
public final class LruArrayPool implements ArrayPool {
     ...
     * <p>
     * 数组池中的数组对象个数作为除数，这样好计算每个数组对象的一些数据信息，
     * 目前只有{@link ByteArrayAdapter}和{@link IntegerArrayAdapter}两个数据对象
     */
    ...
    /**
     * 从集合中返回{@link IntegerArrayAdapter}或{@link ByteArrayAdapter}的实例，
     * 若集合中没有相关实例，则创建一个，并添加到集合中去
     */
    @SuppressWarnings("unchecked")
