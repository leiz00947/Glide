 ...
 * <p>
 * 用默认可用的选项值来定义可用的组件(比如编码器、解码器、数据加载模型等),
 * 通过使用{@link com.bumptech.glide.load.engine.DiskCacheStrategy#RESOURCE}来改变磁盘缓存资源键</p>
 * <p>
...
public final class Option<T> {
    ...
    /**
     * Returns a new {@link Option} that does not affect disk cache keys with a {@code null} default value.
     *
