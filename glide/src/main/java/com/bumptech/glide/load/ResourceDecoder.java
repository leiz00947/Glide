 ...
 *            <p>解码资源的来源类型(如File、InputStream等)</p>
 * @param <Z> The type of the decoded resource (Bitmap, Drawable etc).
 *            <p>解码资源的类型(如Bitmap、Drawable等)</p>
 */
public interface ResourceDecoder<T, Z> {
     ...
     * <p>
     * Decoders should make a best effort attempt to quickly determine if they are likely to be
     ...
     * <p>
     * Decoders that return {@code true} from {@link #handles(Object, Options)} may still
     ...
     * <p>
     * The {@code source} is managed by the caller, there's no need to close it. The returned
     * {@link Resource} will be {@link Resource#recycle() released} when the engine sees fit.
     * <p>
     * Note - The {@code width} and {@code height} arguments are hints only, there is no
