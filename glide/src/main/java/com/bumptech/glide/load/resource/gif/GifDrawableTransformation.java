 ...
 * {@link Bitmap} and can apply it to every frame of any {@link GifDrawable}.
 * <p>
 * {@link Transformation}的实现类，封装一个{@link Transformation<Bitmap>}，适用于任何
 * {@link GifDrawable}的每一帧
 */
