...
public interface DataRewinder<T> {
    ...
    /**
     * A factory interface for producing individual {@link DataRewinder}s.
     *
     * @param <T> The type of data that the {@link DataRewinder} will wrap.
     */
    interface Factory<T> {
        /**
        ...
        /**
         * Returns the class of data this factory can produce {@link DataRewinder}s for.
         */
