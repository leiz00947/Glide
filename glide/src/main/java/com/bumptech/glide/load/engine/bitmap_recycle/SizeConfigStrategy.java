 ...
 * <p>
 * {@link LruPoolStrategy}的实现类，{@link Bitmap}同时使用{@link Bitmap#getAllocationByteCount()}
 * 和{@link Bitmap.Config}来决定
 * <p>
 ...
 * {@link Bitmap Bitmaps} with a matching number of bytes per pixel.
 */
