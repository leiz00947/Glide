...
/**
 * Global context for all loads in Glide containing and exposing the various registries and
 * classes required to load resources.
 * <p>
 * Glide中全局加载Context，包含各种注册和Class的资源加载请求
 */
